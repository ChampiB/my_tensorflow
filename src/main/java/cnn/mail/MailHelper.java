...
public class MailHelper {
    ...
    private void setMailServerProperties() {
        properties.put("cnn.mail.smtp.host", "smtp.gmail.com");
        properties.put("cnn.mail.smtp.port", "587");
        properties.put("cnn.mail.smtp.auth", "true");
        properties.put("cnn.mail.smtp.starttls.enable", "true");
    }
