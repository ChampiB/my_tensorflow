...
import cnn.useful.debug.AccuracyTestingSetDebugFunction;
...
class CNN_vs_HCNN_accuracy {
    ...
    private static void network1(Parameters param) {
        ...
        cnn.fit(dataSet, new EpochsStopCondition(param.epochs), 0.01, new AccuracyTestingSetDebugFunction(param.debug));
    }
