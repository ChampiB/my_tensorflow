...
class Pad2dTest {
    ...
    @Test
    void updateDimZeroCorrectPredictions() {
        ArrayPtr x = create(new float[][][][]{{{{1, 1}}}});
        ArrayPtr t = create(new float[][][][]{{{{1, 1}}}, {{{0, 0}}}});
    ...
    @Test
    void updateDimOneCorrectPredictions() {
        ArrayPtr x = create(new float[][][][]{{{{1, 1}}}});
        ArrayPtr t = create(new float[][][][]{{{{1, 1}}, {{0, 0}}}});
    ...
    @Test
    void updateDimTwoCorrectPredictions() {
        ArrayPtr x = create(new float[][][][]{{{{1, 1}}}});
        ArrayPtr t = create(new float[][][][]{{{{1, 1}, {0, 0}}}});
    ...
    @Test
    void updateDimThreeCorrectPredictions() {
        ArrayPtr x = create(new float[][][][]{{{{1, 1}}}});
        ArrayPtr t = create(new float[][][][]{{{{1, 1, 0, 0}}}});
    ...
    void updateDimZero() {
        ArrayPtr x = create(new float[][][][]{{{{1, 1}}}});
        ArrayPtr t = create(new float[][][][]{{{{2, 2}}}, {{{0, 0}}}});
